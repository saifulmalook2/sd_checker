...
# response = requests.post(url, data=parsed_text_with_spaces, headers={'Content-Type': 'text/html'})
# r = response.json()
...
# # Generate a random token (can be UUID or any custom token)
# secret_token = str(uuid.uuid4())

# # Print or store the token securely (as your `SECRET_TOKEN`)
# print(secret_token)
